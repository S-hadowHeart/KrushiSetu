...
async function getVerification(req, res) {
  const requestedUserId = req.params.userId ? parseInt(req.params.userId, 10) : undefined;
  const userId = req.userRole === 'ADMIN' && requestedUserId ? requestedUserId : req.userId;
