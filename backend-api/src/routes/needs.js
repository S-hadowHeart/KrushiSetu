...
router.post('/', auth, requireRole('BUYER'), validateBody(createNeedSchema), asyncHandler(needsController.createNeed));
router.get('/', asyncHandler(needsController.listNeeds));
router.get('/:publicId', asyncHandler(needsController.getNeed));
router.put('/:publicId', auth, requireRole('BUYER'), validateBody(createNeedSchema), asyncHandler(needsController.updateNeed));
